...
from forms import CreatePostForm, RegisterForm, Log_in, CommentForm
...
class Comment(db.Model):
    ...
    commented_blog_id = db.Column(db.Integer, db.ForeignKey("blog_post.id"))
...
def show_post(post_id):
    ...
    if form.validate_on_submit():
        if not current_user.is_authenticated:
            flash("To leave a comment you are need to log-in or register")
            return redirect(url_for("login"))
        new_comment = Comment(
